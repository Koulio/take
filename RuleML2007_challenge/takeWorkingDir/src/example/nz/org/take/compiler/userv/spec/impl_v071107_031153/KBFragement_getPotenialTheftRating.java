    ...
    static ResourceIterator<PotentialTheftRating> getPotenialTheftRating(
        ...
        ResourceIterator<PotentialTheftRating> result = new IteratorChain<PotentialTheftRating>(5) {
                public Object getIteratorOrObject(int pos) {
                    ...
                    // AE_PTC02  IF greater_than_ii(getPrice(<car>),45000) THEN /potentialTheftRating(<car>,high)
                    case 1:
                    ...
                    // AE_PTC04  IF greater_than_ii(getPrice(<car>),20000) AND less_than_ii(getPrice(<car>),45000) AND contains([HighTheftProbabilityAutoList],getType(<car>)) THEN /potentialTheftRating(<car>,moderate)
                    case 3:
                        return getPotenialTheftRating_3(car,
                            _derivation.reset(_derivationlevel));

                    // AE_PTC05  IF less_than_ii(getPrice(<car>),20000) AND contains([HighTheftProbabilityAutoList],getType(<car>)) THEN /potentialTheftRating(<car>,low)
                    case 4:
    ...
    */
    private static ResourceIterator<PotentialTheftRating> getPotenialTheftRating_3(
        ...
        class bindingsInRule4 {
            ...
            // Property generated for term  "[HighTheftProbabilityAutoList]"
            java.util.Collection p5;

            // Property generated for term  "45000"
            java.lang.Integer p6;

            // Property generated for term  "<car>"
            example.nz.org.take.compiler.userv.domainmodel.Car p7;
        }
        ;
        ...
        bindings.p2 = car.getType();
        bindings.p6 = 45000;
        bindings.p5 = Constants.HighTheftProbabilityAutoList;
        bindings.p7 = car;
        ...
        final ResourceIterator<not_contains> iterator3 = new NestedIterator<less_than_ii, not_contains>(iterator2) {
                public ResourceIterator<not_contains> getNextIterator(
                    ...
                    return KBFragement_not_contains_11.not_contains_11(bindings.p5,
                        bindings.p2, _derivation.increaseDepth());
                }
            };
    ...
    */
    private static ResourceIterator<PotentialTheftRating> getPotenialTheftRating_4(
        ...
        class bindingsInRule5 {
            ...
            // Property generated for term  "<car>"
            example.nz.org.take.compiler.userv.domainmodel.Car p6;
        }
        ;
        ...
        final ResourceIterator<less_than_ii> iterator1 = KBFragement_less_than_ii_11.less_than_ii_11(bindings.p4,
                20000, _derivation.increaseDepth());
