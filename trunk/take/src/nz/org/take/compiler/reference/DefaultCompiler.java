...
public class DefaultCompiler extends CompilerUtils  implements Compiler {
	...
	public void compile(KnowledgeBase kb, List<Query> queries,Location location, String packageName, String className)throws CompilerException {
		...
		String constantClassName = packageName + ".Constants";
		this.kb = kb;
		try {
			PrintWriter out = new PrintWriter(location.getSrcOut(constantClassName));
			createConstantsClass(out,"Constants", packageName);
			out.close();
	 ...
	 */
	private void createConstantsClass(PrintWriter out, String clazz, String pck) throws CompilerException {
