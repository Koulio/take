    ...
    static ResourceIterator<AutoEligibility> getAutoEligibility(
        ...
        ResourceIterator<AutoEligibility> result = new IteratorChain<AutoEligibility>(4) {
                public Object getIteratorOrObject(int pos) {
                    ...
                    // AE_04  IF  THEN /autoEligibility(<car>,eligible)
                    case 3:
    ...
    static ResourceIterator<AutoEligibility> getAutoEligibility(
        ...
        ResourceIterator<AutoEligibility> result = new IteratorChain<AutoEligibility>(4) {
                public Object getIteratorOrObject(int pos) {
                    ...
                    // AE_01  IF /potentialOccupantInjuryRating(<car>,extremely high) THEN /autoEligibility(<car>,not eligible)
                    case 0:
                        return getAutoEligibility_0(car, value,
                            _derivation.reset(_derivationlevel));

                    // AE_02  IF /potentialOccupantInjuryRating(<car>,high) THEN /autoEligibility(<car>,provisional)
                    case 1:
                        return getAutoEligibility_1(car, value,
                            _derivation.reset(_derivationlevel));

                    // AE_03  IF /potentialTheftRating(<car>,high) THEN /autoEligibility(<car>,provisional)
                    case 2:
                        return getAutoEligibility_2(car, value,
                            _derivation.reset(_derivationlevel));

                    // AE_04  IF  THEN /autoEligibility(<car>,eligible)
                    case 3:
                        return getAutoEligibility_3(car, value,
                            _derivation.reset(_derivationlevel));
