    ...
    static ResourceIterator<DriverCategory> getDriverCategory(
        ...
        ResourceIterator<DriverCategory> result = new IteratorChain<DriverCategory>(4) {
                public Object getIteratorOrObject(int pos) {
                    switch (pos) {
                    // DE_DAC01  IF isMale(<driver>) AND less_than_ii(getAge(<driver>),25) THEN /driverCategory(<driver>,young driver)
                    case 0:
                        return getDriverCategory_0(driver,
                            _derivation.reset(_derivationlevel));

                    // DE_DAC02  IF isMale(<driver>) AND less_than_ii(getAge(<driver>),20) THEN /driverCategory(<driver>,young driver)
                    case 1:
                        return getDriverCategory_1(driver,
                            _derivation.reset(_derivationlevel));

                    // DE_DAC04  IF greater_than_ii(getAge(<driver>),70) THEN /driverCategory(<driver>,senior driver)
                    case 2:
