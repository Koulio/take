...
class KBFragement_autoEligibility_11 {
    /**
     * Method generated for query /autoEligibility[in,in]
     * @param car input parameter generated from slot 0
     * @param value input parameter generated from slot 1
     * @return an iterator for instances of AutoEligibility
    */
    public static ResultSet<AutoEligibility> autoEligibility_11(
        final example.nz.org.take.compiler.userv.domainmodel.Car car,
        final java.lang.String value) {
        DerivationController _derivation = new DefaultDerivationController();
        ResultSet<AutoEligibility> _result = new ResultSet(KBFragement_autoEligibility_11.autoEligibility_11(
                    car, value, _derivation), _derivation);
     ...
     * @return an iterator for instances of AutoEligibility
    */
    static ResourceIterator<AutoEligibility> autoEligibility_11(
        final example.nz.org.take.compiler.userv.domainmodel.Car car,
        final java.lang.String value, final DerivationController _derivation) {
     ...
     * @return an iterator for instances of AutoEligibility
    */
    private static ResourceIterator<AutoEligibility> autoEligibility_11_0(
        final example.nz.org.take.compiler.userv.domainmodel.Car car,
        final java.lang.String value, final DerivationController _derivation) {
        _derivation.log("AE_01", DerivationController.RULE, car, value);

        // comparing constants in rule head with parameters
        if (!"not eligible".equals(value)) {
            return EmptyIterator.DEFAULT;
        }
     ...
     * @return an iterator for instances of AutoEligibility
    */
    private static ResourceIterator<AutoEligibility> autoEligibility_11_1(
        final example.nz.org.take.compiler.userv.domainmodel.Car car,
        final java.lang.String value, final DerivationController _derivation) {
        _derivation.log("AE_02", DerivationController.RULE, car, value);

        // comparing constants in rule head with parameters
        if (!"provisional".equals(value)) {
            return EmptyIterator.DEFAULT;
        }
     ...
     * @return an iterator for instances of AutoEligibility
    */
    private static ResourceIterator<AutoEligibility> autoEligibility_11_2(
        final example.nz.org.take.compiler.userv.domainmodel.Car car,
        final java.lang.String value, final DerivationController _derivation) {
        _derivation.log("AE_03", DerivationController.RULE, car, value);
     ...
     * @return an iterator for instances of AutoEligibility
    */
    private static ResourceIterator<AutoEligibility> autoEligibility_11_3(
        final example.nz.org.take.compiler.userv.domainmodel.Car car,
        final java.lang.String value, final DerivationController _derivation) {
        _derivation.log("AE_04", DerivationController.RULE, car, value);
