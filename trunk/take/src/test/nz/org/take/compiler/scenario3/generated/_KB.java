 ...
 * @version Mon Apr 30 22:42:15 NZST 2007
 */
@SuppressWarnings("unchecked")
public class _KB {
    /**
     * Method generated for query nz.org.take.SimplePredicate@3e5b4ac
    ...
    private ResourceIterator<IsBrotherRelationship> isBrother(
        ...
        ResourceIterator<IsBrotherRelationship> result = new IteratorChain<IsBrotherRelationship>(1) {
                public Object getIteratorOrObject(int pos) {
                    switch (pos) {
                    // nz.org.take.DerivationRule@b82368
                    case 0:
    ...
    */
    private ResourceIterator<IsBrotherRelationship> isBrother_0(
        ...
        final test.nz.org.take.compiler.scenario3.Person person2,
        final DerivationController _derivation) {
        _derivation.log("rule1"); // Variable bindings in rule: nz.org.take.DerivationRule@b82368
        class bindingsInRule1 {
            // Property generated for term  "nz.org.take.ComplexTerm@15cda3f"
            test.nz.org.take.compiler.scenario3.Person p1;

            // Property generated for term  "nz.org.take.Variable@c53dce"
