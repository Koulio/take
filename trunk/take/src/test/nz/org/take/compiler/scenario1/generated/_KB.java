 ...
 * @version Fri May 11 14:44:27 NZST 2007
 */
@SuppressWarnings("unchecked")
public class _KB {
    /**
     * Method generated for query nz.org.take.SimplePredicate@abeac510
    ...
    private ResourceIterator<IsFatherOf> getFather(final java.lang.String son,
        ...
        ResourceIterator<IsFatherOf> result = new IteratorChain<IsFatherOf>(8) {
                public Object getIteratorOrObject(int pos) {
                    switch (pos) {
                    // nz.org.take.Fact@11756a4
                    case 0:
                        return getFather_0(son,
                            _derivation.reset(_derivationlevel));

                    // nz.org.take.Fact@13936e1
                    case 1:
                        return getFather_1(son,
                            _derivation.reset(_derivationlevel));

                    // nz.org.take.Fact@141fab6
                    case 2:
                        return getFather_2(son,
                            _derivation.reset(_derivationlevel));

                    // nz.org.take.Fact@b301f2
                    case 3:
                        return getFather_3(son,
                            _derivation.reset(_derivationlevel));

                    // nz.org.take.Fact@44cbbe
                    case 4:
                        return getFather_4(son,
                            _derivation.reset(_derivationlevel));

                    // nz.org.take.Fact@9c2715
                    case 5:
                        return getFather_5(son,
                            _derivation.reset(_derivationlevel));

                    // nz.org.take.Fact@1c9e67a
                    case 6:
                        return getFather_6(son,
                            _derivation.reset(_derivationlevel));

                    // nz.org.take.Fact@3a5794
                    case 7:
    ...
    */
    ...
    /**
     * Method generated for query nz.org.take.SimplePredicate@77bf368e
    ...
    */
    private ResourceIterator<IsGrandfatherOf> getGrandfather(
        ...
        ResourceIterator<IsGrandfatherOf> result = new IteratorChain<IsGrandfatherOf>(1) {
                public Object getIteratorOrObject(int pos) {
                    switch (pos) {
                    // nz.org.take.DerivationRule@4be2cc
                    case 0:
    ...
    */
    private ResourceIterator<IsGrandfatherOf> getGrandfather_0(
        final java.lang.String grandson, final DerivationController _derivation) {
        _derivation.log("rule2"); // Variable bindings in rule: nz.org.take.DerivationRule@4be2cc
        class bindingsInRule1 {
            // Property generated for term  "nz.org.take.Variable@1c208b0"
            java.lang.String p1;

            // Property generated for term  "nz.org.take.Variable@1c888d9"
            java.lang.String p2;

            // Property generated for term  "nz.org.take.Variable@908881"
            java.lang.String p3;
        }
        ;
        ...
        // code for prereq nz.org.take.Prerequisite@1d88db7
        final ResourceIterator<IsFatherOf> iterator1 = getFather(grandson,
                _derivation.increaseDepth());

        // code for prereq nz.org.take.Prerequisite@402af3
        ...
        // code for prereq nz.org.take.Fact@c3e9e9
