 ...
 * @version Mon May 14 11:49:57 NZST 2007
 */
...
public class _KB {
    ...
    private ResourceIterator<IsFatherOf> getFather(final java.lang.String son,
        ...
        ResourceIterator<IsFatherOf> result = new IteratorChain<IsFatherOf>(8) {
                public Object getIteratorOrObject(int pos) {
                    switch (pos) {
                    // nz.org.take.Fact@23756
                    case 0:
                        return getFather_0(son,
                            _derivation.reset(_derivationlevel));

                    // nz.org.take.Fact@17f11fb
                    case 1:
                        return getFather_1(son,
                            _derivation.reset(_derivationlevel));

                    // nz.org.take.Fact@175ade6
                    case 2:
                        return getFather_2(son,
                            _derivation.reset(_derivationlevel));

                    // nz.org.take.Fact@ebf068
                    case 3:
                        return getFather_3(son,
                            _derivation.reset(_derivationlevel));

                    // nz.org.take.Fact@1f44ec7
                    case 4:
                        return getFather_4(son,
                            _derivation.reset(_derivationlevel));

                    // nz.org.take.Fact@602b6b
                    case 5:
                        return getFather_5(son,
                            _derivation.reset(_derivationlevel));

                    // nz.org.take.Fact@1c297a3
                    case 6:
                        return getFather_6(son,
                            _derivation.reset(_derivationlevel));

                    // nz.org.take.Fact@717323
                    case 7:
    ...
    */
    private ResourceIterator<IsGrandfatherOf> getGrandfather(
        ...
        ResourceIterator<IsGrandfatherOf> result = new IteratorChain<IsGrandfatherOf>(1) {
                public Object getIteratorOrObject(int pos) {
                    switch (pos) {
                    // nz.org.take.DerivationRule@3e1bc8
                    case 0:
    ...
    */
    private ResourceIterator<IsGrandfatherOf> getGrandfather_0(
        final java.lang.String grandson, final DerivationController _derivation) {
        _derivation.log("rule2"); // Variable bindings in rule: nz.org.take.DerivationRule@3e1bc8
        class bindingsInRule1 {
            // Property generated for term  "nz.org.take.Variable@191f801"
            java.lang.String p1;

            // Property generated for term  "nz.org.take.Variable@313170"
            java.lang.String p2;

            // Property generated for term  "nz.org.take.Variable@1a4c5b4"
            java.lang.String p3;
        }
        ;
        ...
        // code for prereq nz.org.take.Prerequisite@afae4a
        final ResourceIterator<IsFatherOf> iterator1 = getFather(grandson,
                _derivation.increaseDepth());

        // code for prereq nz.org.take.Prerequisite@1db9852
        ...
        // code for prereq nz.org.take.Fact@1ed5459
