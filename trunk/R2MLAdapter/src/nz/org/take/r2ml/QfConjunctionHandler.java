...
public class QfConjunctionHandler implements XmlTypeHandler {
	...
	public Object importObject(Object obj, MappingContext context, R2MLDriver driver) throws R2MLException {
		...
		try {
			...
			for (JAXBElement<? extends QfAndOrNafNegFormula> item : formula.getQfAndOrNafNegFormula()) {
				...
				Object takeArtefact = handler.importObject(item.getValue(), context, driver);
