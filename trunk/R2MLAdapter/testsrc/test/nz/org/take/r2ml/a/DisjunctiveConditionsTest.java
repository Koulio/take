	...
	public void testMisc() {
		...
		try {
			Reader is = new FileReader(new File(
					"testsrc/test/nz/org/take/r2ml/a/DisjunctiveConditionsTest1.xml"));
			...
			e.printStackTrace();
			fail("FileNotFound: " + e.toString());
		}
		assertNotNull("KnowledgeBase is null.", kb);
		assertEquals("KnowledgeBase contains the wrong number of rules.", 2, kb.getElements().size());
	}
