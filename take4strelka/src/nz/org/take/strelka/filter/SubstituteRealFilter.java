 ...
 * 
 */
public class SubstituteRealFilter implements
	...
	public void repair(RuleBase ruleBase) throws R2MLException {
		...
		// here is an error in the return value of QName.getLocalPart()
		// introduced by strelka.
		// it should return only the localpart, but does returns also the
		// namespace-prefix
		...
		while (stuff2replace.hasNext()) {
			...
			if (obj instanceof TypedLiteral) {
				...
				System.out
						.println("Unable to replace xs:real occurence. Modify SubstituteRealFilter to handle "
