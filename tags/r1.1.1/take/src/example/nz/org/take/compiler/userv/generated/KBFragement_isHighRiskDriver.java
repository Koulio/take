...
class KBFragement_isHighRiskDriver {
    ...
    static ResourceIterator<HighRiskDriver> isHighRiskDriver(
        ...
        ResourceIterator<HighRiskDriver> result = new IteratorChain<HighRiskDriver>(3) {
                public Object getIteratorOrObject(int pos) {
                    switch (pos) {
                    //  IF hasBeenConvictedOfaDUI(<driver>) THEN /isHighRiskDriver(<driver>)
                    case 0:
                        return isHighRiskDriver_0(driver,
                            _derivation.reset(_derivationlevel));

                    //  IF greater_than_ii(getNumberOfAccidentsInvolvedIn(<driver>),2) THEN /isHighRiskDriver(<driver>)
                    case 1:
                        return isHighRiskDriver_1(driver,
                            _derivation.reset(_derivationlevel));

                    //  IF greater_than_ii(getNumberOfMovingViolationsInLastTwoYears(<driver>),3) THEN /isHighRiskDriver(<driver>)
                    case 2:
    ...
    */
    private static ResourceIterator<HighRiskDriver> isHighRiskDriver_0(
        ...
        final ResourceIterator<_hasBeenConvictedOfaDUI> iterator1 = KBFragement_hasBeenConvictedOfaDUI_1.hasBeenConvictedOfaDUI_1(driver,
                _derivation.increaseDepth());

        // code for prereq /isHighRiskDriver(<driver>)
        final ResourceIterator<HighRiskDriver> iterator2 = new NestedIterator<_hasBeenConvictedOfaDUI, HighRiskDriver>(iterator1) {
                public ResourceIterator<HighRiskDriver> getNextIterator(
                    _hasBeenConvictedOfaDUI object) {
    ...
    */
    private static ResourceIterator<HighRiskDriver> isHighRiskDriver_1(
        ...
        final ResourceIterator<_greater_than_ii> iterator1 = KBFragement_greater_than_ii_11.greater_than_ii_11(driver.getNumberOfAccidentsInvolvedIn(),
                2, _derivation.increaseDepth());

        // code for prereq /isHighRiskDriver(<driver>)
        final ResourceIterator<HighRiskDriver> iterator2 = new NestedIterator<_greater_than_ii, HighRiskDriver>(iterator1) {
                public ResourceIterator<HighRiskDriver> getNextIterator(
    ...
    */
    private static ResourceIterator<HighRiskDriver> isHighRiskDriver_2(
        ...
        bindings.p3 = 3;
        bindings.p1 = driver.getNumberOfMovingViolationsInLastTwoYears();
        bindings.p2 = driver;

        // code for prereq greater_than_ii(getNumberOfMovingViolationsInLastTwoYears(<driver>),3)
        final ResourceIterator<_greater_than_ii> iterator1 = KBFragement_greater_than_ii_11.greater_than_ii_11(driver.getNumberOfMovingViolationsInLastTwoYears(),
