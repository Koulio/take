 ...
 * @version Thu May 03 11:11:00 NZST 2007
 */
...
public class _KB {
    ...
    private ResourceIterator<IsFatherOf> getFather(final java.lang.String son,
        ...
        ResourceIterator<IsFatherOf> result = new IteratorChain<IsFatherOf>(8) {
                public Object getIteratorOrObject(int pos) {
                    switch (pos) {
                    // nz.org.take.Fact@1f64158
                    case 0:
                        return getFather_0(son,
                            _derivation.reset(_derivationlevel));

                    // nz.org.take.Fact@3c2378
                    case 1:
                        return getFather_1(son,
                            _derivation.reset(_derivationlevel));

                    // nz.org.take.Fact@3cc262
                    case 2:
                        return getFather_2(son,
                            _derivation.reset(_derivationlevel));

                    // nz.org.take.Fact@fdb00d
                    case 3:
                        return getFather_3(son,
                            _derivation.reset(_derivationlevel));

                    // nz.org.take.Fact@131303f
                    case 4:
                        return getFather_4(son,
                            _derivation.reset(_derivationlevel));

                    // nz.org.take.Fact@56860b
                    case 5:
                        return getFather_5(son,
                            _derivation.reset(_derivationlevel));

                    // nz.org.take.Fact@7a5a19
                    case 6:
                        return getFather_6(son,
                            _derivation.reset(_derivationlevel));

                    // nz.org.take.Fact@b122a1
                    case 7:
    ...
    */
    private ResourceIterator<IsGrandfatherOf> getGrandfather(
        ...
        ResourceIterator<IsGrandfatherOf> result = new IteratorChain<IsGrandfatherOf>(1) {
                public Object getIteratorOrObject(int pos) {
                    switch (pos) {
                    // nz.org.take.DerivationRule@f18e8e
                    case 0:
    ...
    */
    private ResourceIterator<IsGrandfatherOf> getGrandfather_0(
        final java.lang.String grandson, final DerivationController _derivation) {
        _derivation.log("rule2"); // Variable bindings in rule: nz.org.take.DerivationRule@f18e8e
        class bindingsInRule1 {
            // Property generated for term  "nz.org.take.Variable@50ca0c"
            java.lang.String p1;

            // Property generated for term  "nz.org.take.Variable@e753"
            java.lang.String p2;

            // Property generated for term  "nz.org.take.Variable@15311bd"
            java.lang.String p3;
        }
        ;
        ...
        // code for prereq nz.org.take.Prerequisite@1478a43
        final ResourceIterator<IsFatherOf> iterator1 = getFather(grandson,
                _derivation.increaseDepth());

        // code for prereq nz.org.take.Prerequisite@1c65216
        ...
        // code for prereq nz.org.take.Fact@1372656
