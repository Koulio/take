 ...
 * @version Sun May 06 21:55:40 NZST 2007
 */
@SuppressWarnings("unchecked")
public class _KB {
    /**
     * Method generated for query nz.org.take.SimplePredicate@8c0a213d
    ...
    private ResourceIterator<IsFatherOf> getFather(final java.lang.String son,
        ...
        ResourceIterator<IsFatherOf> result = new IteratorChain<IsFatherOf>(8) {
                public Object getIteratorOrObject(int pos) {
                    switch (pos) {
                    // nz.org.take.Fact@17e6a96
                    case 0:
                        return getFather_0(son,
                            _derivation.reset(_derivationlevel));

                    // nz.org.take.Fact@87a5cc
                    case 1:
                        return getFather_1(son,
                            _derivation.reset(_derivationlevel));

                    // nz.org.take.Fact@1960f05
                    case 2:
                        return getFather_2(son,
                            _derivation.reset(_derivationlevel));

                    // nz.org.take.Fact@b42cbf
                    case 3:
                        return getFather_3(son,
                            _derivation.reset(_derivationlevel));

                    // nz.org.take.Fact@e5b723
                    case 4:
                        return getFather_4(son,
                            _derivation.reset(_derivationlevel));

                    // nz.org.take.Fact@15a8767
                    case 5:
                        return getFather_5(son,
                            _derivation.reset(_derivationlevel));

                    // nz.org.take.Fact@6f7ce9
                    case 6:
                        return getFather_6(son,
                            _derivation.reset(_derivationlevel));

                    // nz.org.take.Fact@171bbc9
                    case 7:
    ...
    */
    ...
    /**
     * Method generated for query nz.org.take.SimplePredicate@274287ff
    ...
    */
    private ResourceIterator<IsGrandfatherOf> getGrandfather(
        ...
        ResourceIterator<IsGrandfatherOf> result = new IteratorChain<IsGrandfatherOf>(1) {
                public Object getIteratorOrObject(int pos) {
                    switch (pos) {
                    // nz.org.take.DerivationRule@76cbf7
                    case 0:
    ...
    */
    private ResourceIterator<IsGrandfatherOf> getGrandfather_0(
        final java.lang.String grandson, final DerivationController _derivation) {
        _derivation.log("rule2"); // Variable bindings in rule: nz.org.take.DerivationRule@76cbf7
        class bindingsInRule1 {
            // Property generated for term  "nz.org.take.Variable@6d084b"
            java.lang.String p1;

            // Property generated for term  "nz.org.take.Variable@3bb2b8"
            java.lang.String p2;

            // Property generated for term  "nz.org.take.Variable@152544e"
            java.lang.String p3;
        }
        ;
        ...
        // code for prereq nz.org.take.Prerequisite@1e04cbf
        final ResourceIterator<IsFatherOf> iterator1 = getFather(grandson,
                _derivation.increaseDepth());

        // code for prereq nz.org.take.Prerequisite@cec0c5
        ...
        // code for prereq nz.org.take.Fact@1d2068d
