 ...
 * @version Thu May 03 12:44:33 NZST 2007
 */
...
public class _KB {
    ...
    private ResourceIterator<IsFatherOf> getFather(final java.lang.String son,
        ...
        ResourceIterator<IsFatherOf> result = new IteratorChain<IsFatherOf>(8) {
                public Object getIteratorOrObject(int pos) {
                    switch (pos) {
                    // nz.org.take.Fact@102799c
                    case 0:
                        return getFather_0(son,
                            _derivation.reset(_derivationlevel));

                    // nz.org.take.Fact@17e121c
                    case 1:
                        return getFather_1(son,
                            _derivation.reset(_derivationlevel));

                    // nz.org.take.Fact@1d6f122
                    case 2:
                        return getFather_2(son,
                            _derivation.reset(_derivationlevel));

                    // nz.org.take.Fact@7109c4
                    case 3:
                        return getFather_3(son,
                            _derivation.reset(_derivationlevel));

                    // nz.org.take.Fact@1385660
                    case 4:
                        return getFather_4(son,
                            _derivation.reset(_derivationlevel));

                    // nz.org.take.Fact@1aed5f9
                    case 5:
                        return getFather_5(son,
                            _derivation.reset(_derivationlevel));

                    // nz.org.take.Fact@161dfb5
                    case 6:
                        return getFather_6(son,
                            _derivation.reset(_derivationlevel));

                    // nz.org.take.Fact@a613f8
                    case 7:
    ...
    */
    private ResourceIterator<IsGrandfatherOf> getGrandfather(
        ...
        ResourceIterator<IsGrandfatherOf> result = new IteratorChain<IsGrandfatherOf>(1) {
                public Object getIteratorOrObject(int pos) {
                    switch (pos) {
                    // nz.org.take.DerivationRule@589e56
                    case 0:
    ...
    */
    private ResourceIterator<IsGrandfatherOf> getGrandfather_0(
        final java.lang.String grandson, final DerivationController _derivation) {
        _derivation.log("rule2"); // Variable bindings in rule: nz.org.take.DerivationRule@589e56
        class bindingsInRule1 {
            // Property generated for term  "nz.org.take.Variable@1a7508a"
            java.lang.String p1;

            // Property generated for term  "nz.org.take.Variable@198cb3d"
            java.lang.String p2;

            // Property generated for term  "nz.org.take.Variable@472d48"
            java.lang.String p3;
        }
        ;
        ...
        // code for prereq nz.org.take.Prerequisite@2bc3f5
        final ResourceIterator<IsFatherOf> iterator1 = getFather(grandson,
                _derivation.increaseDepth());

        // code for prereq nz.org.take.Prerequisite@14e3f41
        ...
        // code for prereq nz.org.take.Fact@1acd47
