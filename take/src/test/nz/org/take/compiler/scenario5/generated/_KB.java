...
public class _KB {
    ...
    */
    private ResourceIterator<discount> getDiscount_0(
        final test.nz.org.take.compiler.scenario5.Customer customer,
        final DerivationController _derivation) {
        _derivation.log("rule1"); // Variable bindings in rule:  IF equals(getCategory(<customer>),[goldCustomer]) THEN /discount(<customer>,[goldCustomerDiscount])
    ...
    */
    private ResourceIterator<_equals> equals_11(
        ...
        _derivation.log(
            "public boolean test.nz.org.take.compiler.scenario5.CustomerCategory.equals(java.lang.Object)");
