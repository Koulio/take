...
class KBFragement_getAdditionalDriverPremium {
    ...
    */
    static ResourceIterator<AdditionalDriverPremium> getAdditionalDriverPremium(
        ...
        ResourceIterator<AdditionalDriverPremium> result = new IteratorChain<AdditionalDriverPremium>(9) {
                public Object getIteratorOrObject(int pos) {
                    switch (pos) {
                    //  IF /driverCategory(<driver>,young driver) AND isMarried(<driver>) AND /specialLocation(<driver>) THEN /additionalDriverPremium(<driver>,700)
                    case 0:
                        return getAdditionalDriverPremium_0(driver,
                            _derivation.reset(_derivationlevel));

                    //  IF /driverCategory(<driver>,young driver) AND isMarried(<driver>) AND /specialLocation(<driver>) THEN /additionalDriverPremium(<driver>,720)
                    case 1:
                        return getAdditionalDriverPremium_1(driver,
                            _derivation.reset(_derivationlevel));

                    //  IF /driverCategory(<driver>,young driver) AND isMarried(<driver>) AND /specialLocation(<driver>) THEN /additionalDriverPremium(<driver>,300)
                    case 2:
                    ...
                    //  IF /driverCategory(<driver>,senior driver) AND /specialLocation(<driver>) THEN /additionalDriverPremium(<driver>,500)
                    case 4:
                        return getAdditionalDriverPremium_4(driver,
                            _derivation.reset(_derivationlevel));

                    //  IF /driverCategory(<driver>,senior driver) AND /specialLocation(<driver>) THEN /additionalDriverPremium(<driver>,200)
                    case 5:
                        return getAdditionalDriverPremium_5(driver,
                            _derivation.reset(_derivationlevel));

                    //  IF /isHighRiskDriver(<driver>) THEN /additionalDriverPremium(<driver>,1000)
                    case 6:
                        return getAdditionalDriverPremium_6(driver,
                            _derivation.reset(_derivationlevel));

                    //  IF isPreferred(<client>) THEN /additionalDriverPremium(<client>,-250)
                    case 7:
                        return getAdditionalDriverPremium_7(driver,
                            _derivation.reset(_derivationlevel));

                    //  IF isElite(<client>) THEN /additionalDriverPremium(<client>,-500)
                    case 8:
    ...
    private static ResourceIterator<AdditionalDriverPremium> getAdditionalDriverPremium_0(
        ...
        final ResourceIterator<isMarried> iterator2 = new NestedIterator<DriverCategory, isMarried>(iterator1) {
                public ResourceIterator<isMarried> getNextIterator(
                    ...
                    return KBFragement_isMarried_1.isMarried_1(bindings.p1,
    ...
    private static ResourceIterator<AdditionalDriverPremium> getAdditionalDriverPremium_1(
        ...
        final ResourceIterator<not_isMarried> iterator2 = new NestedIterator<DriverCategory, not_isMarried>(iterator1) {
                public ResourceIterator<not_isMarried> getNextIterator(
                    ...
                    return KBFragement_not_isMarried_1.not_isMarried_1(bindings.p1,
                        _derivation.increaseDepth());
                }
            };
