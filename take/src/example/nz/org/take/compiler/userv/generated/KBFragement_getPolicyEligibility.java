    ...
    static ResourceIterator<InsuranceEligibility> getPolicyEligibility(
        ...
        ResourceIterator<InsuranceEligibility> result = new IteratorChain<InsuranceEligibility>(4) {
                public Object getIteratorOrObject(int pos) {
                    ...
                    //  IF greater_than_or_equal_ii(eligibilityScore(<car>,<client>),100) AND less_than_or_equal_ii(eligibilityScore(<car>,<client>),250) THEN /insuranceEligibility(<car>,<client>,must be reviewed by underwriting manager)
                    case 1:
                        return getPolicyEligibility_1(car, driver,
                            _derivation.reset(_derivationlevel));

                    //  IF greater_than_ii(eligibilityScore(<car>,<client>),250) THEN /insuranceEligibility(<car>,<client>,not eligible)
                    case 2:
                        return getPolicyEligibility_2(car, driver,
                            _derivation.reset(_derivationlevel));

                    //  IF /isLongTermClient(<client>) THEN /insuranceEligibility(<car>,<client>,eligible)
                    case 3:
    ...
    */
    private static ResourceIterator<InsuranceEligibility> getPolicyEligibility_0(
        ...
        class bindingsInRule34 {
            ...
            example.nz.org.take.compiler.userv.domainmodel.Driver p5;
        }
        ;
        ...
        final ResourceIterator<InsuranceEligibility> iterator2 = new NestedIterator<less_than_ii, InsuranceEligibility>(iterator1) {
                public ResourceIterator<InsuranceEligibility> getNextIterator(
                    ...
                    return new SingletonIterator(new InsuranceEligibility(
                            bindings.p4, bindings.p5, bindings.p3));
                }
            };
    ...
    */
    private static ResourceIterator<InsuranceEligibility> getPolicyEligibility_1(
        ...
        class bindingsInRule35 {
            ...
            // Property generated for term  "<client>"
            example.nz.org.take.compiler.userv.domainmodel.Driver p6;
        }
        ;
        ...
        final ResourceIterator<InsuranceEligibility> iterator3 = new NestedIterator<less_than_or_equal_ii, InsuranceEligibility>(iterator2) {
                public ResourceIterator<InsuranceEligibility> getNextIterator(
                    ...
                    return new SingletonIterator(new InsuranceEligibility(
                            bindings.p3, bindings.p6, bindings.p5));
                }
            };
    ...
    private static ResourceIterator<InsuranceEligibility> getPolicyEligibility_2(
        ...
        final ResourceIterator<InsuranceEligibility> iterator2 = new NestedIterator<greater_than_ii, InsuranceEligibility>(iterator1) {
                public ResourceIterator<InsuranceEligibility> getNextIterator(
                    ...
                    return new SingletonIterator(new InsuranceEligibility(
                            bindings.p3, bindings.p5, bindings.p2));
                }
            };
