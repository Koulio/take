...
class KBFragement_getPolicyEligibility {
    ...
    */
    private static ResourceIterator<InsuranceEligibility> getPolicyEligibility_1(
        ...
        bindings.p2 = car;
        bindings.p6 = 250;
        bindings.p7 = "must be reviewed by underwriting manager";
        ...
        final ResourceIterator<greater_than_or_equal_ii> iterator1 = KBFragement_greater_than_or_equal_ii_11.greater_than_or_equal_ii_11(Aggregations.eligibilityScore(
                    car, driver), 100, _derivation.increaseDepth());
        ...
        final ResourceIterator<less_than_or_equal_ii> iterator2 = new NestedIterator<greater_than_or_equal_ii, less_than_or_equal_ii>(iterator1) {
                public ResourceIterator<less_than_or_equal_ii> getNextIterator(
                    ...
                    return KBFragement_less_than_or_equal_ii_11.less_than_or_equal_ii_11(bindings.p5,
        ...
        final ResourceIterator<InsuranceEligibility> iterator3 = new NestedIterator<less_than_or_equal_ii, InsuranceEligibility>(iterator2) {
                public ResourceIterator<InsuranceEligibility> getNextIterator(
                    ...
                    return new SingletonIterator(new InsuranceEligibility(
                            bindings.p2, bindings.p3, bindings.p7));
                }
            };
    ...
    */
    private static ResourceIterator<InsuranceEligibility> getPolicyEligibility_2(
        ...
        bindings.p1 = Aggregations.eligibilityScore(car, driver);
        bindings.p5 = "not eligible";
        bindings.p2 = car;
        bindings.p4 = 250;
        bindings.p3 = driver;

        // code for prereq greater_than_ii(eligibilityScore(<car>,<client>),250)
        final ResourceIterator<greater_than_ii> iterator1 = KBFragement_greater_than_ii_11.greater_than_ii_11(Aggregations.eligibilityScore(
                    car, driver), 250, _derivation.increaseDepth());
