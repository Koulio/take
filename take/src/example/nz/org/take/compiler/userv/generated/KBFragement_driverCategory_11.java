...
class KBFragement_driverCategory_11 {
    /**
    ...
    */
    public static ResultSet<DriverCategory> driverCategory_11(
        final example.nz.org.take.compiler.userv.domainmodel.Driver driver,
        final java.lang.String category) {
        DerivationController _derivation = new DefaultDerivationController();
        ResultSet<DriverCategory> _result = new ResultSet(KBFragement_driverCategory_11.driverCategory_11(
     ...
     * @return an iterator for instances of DriverCategory
    */
    static ResourceIterator<DriverCategory> driverCategory_11(
        final example.nz.org.take.compiler.userv.domainmodel.Driver driver,
     ...
     * @return an iterator for instances of DriverCategory
    */
    private static ResourceIterator<DriverCategory> driverCategory_11_0(
        final example.nz.org.take.compiler.userv.domainmodel.Driver driver,
        final java.lang.String category, final DerivationController _derivation) {
     ...
     * @return an iterator for instances of DriverCategory
    */
    private static ResourceIterator<DriverCategory> driverCategory_11_1(
        final example.nz.org.take.compiler.userv.domainmodel.Driver driver,
        final java.lang.String category, final DerivationController _derivation) {
     ...
     * @return an iterator for instances of DriverCategory
    */
    private static ResourceIterator<DriverCategory> driverCategory_11_2(
        final example.nz.org.take.compiler.userv.domainmodel.Driver driver,
        final java.lang.String category, final DerivationController _derivation) {
     ...
     * @return an iterator for instances of DriverCategory
    */
    private static ResourceIterator<DriverCategory> driverCategory_11_3(
        final example.nz.org.take.compiler.userv.domainmodel.Driver driver,
        final java.lang.String category, final DerivationController _derivation) {
        _derivation.log("X1_DE_DAC", DerivationController.RULE, driver, category);

        // rule with empty body
        // comparing constants in rule head with parameters
        if (!"standard driver".equals(category)) {
            return EmptyIterator.DEFAULT;
        }
