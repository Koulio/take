...
class KBFragement_getDriverEligibility {
    ...
    */
    private static ResourceIterator<DriverEligibility> getDriverEligibility_0(
        ...
        final ResourceIterator<_hasTrainingCertification> iterator2 = new NestedIterator<DriverCategory, _hasTrainingCertification>(iterator1) {
                public ResourceIterator<_hasTrainingCertification> getNextIterator(
                    DriverCategory object) {
                    bindings.p1 = object.driver;
                    bindings.p2 = "young driver";

                    return KBFragement_hasTrainingCertification_1.hasTrainingCertification_1(bindings.p1,
                        _derivation.increaseDepth());
                }
            };

        // code for prereq /isEligible(<driver>)
        final ResourceIterator<DriverEligibility> iterator3 = new NestedIterator<_hasTrainingCertification, DriverEligibility>(iterator2) {
                public ResourceIterator<DriverEligibility> getNextIterator(
                    _hasTrainingCertification object) {
