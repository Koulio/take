...
class KBFragement_getDriverEligibility {
    ...
    static ResourceIterator<DriverEligibility> getDriverEligibility(
        ...
        ResourceIterator<DriverEligibility> result = new IteratorChain<DriverEligibility>(3) {
                public Object getIteratorOrObject(int pos) {
                    ...
                    //  IF /driverCategory(<driver>,standard driver) AND /driverCategory(<driver>,young driver) THEN /isEligible(<driver>)
                    case 2:
    ...
    */
    private static ResourceIterator<DriverEligibility> getDriverEligibility_2(
        ...
        // Variable bindings in rule:  IF /driverCategory(<driver>,standard driver) AND /driverCategory(<driver>,young driver) THEN /isEligible(<driver>)
        class bindingsInRule19 {
            // Property generated for term  "<driver>"
            example.nz.org.take.compiler.userv.domainmodel.Driver p1;

            // Property generated for term  "standard driver"
            java.lang.String p2;
        ...
        bindings.p1 = driver;
        bindings.p2 = "standard driver";

        // code for prereq /driverCategory(<driver>,standard driver)
        final ResourceIterator<not_DriverCategory> iterator1 = KBFragement_not_driverCategory_11.not_driverCategory_11(driver,
                "standard driver", _derivation.increaseDepth());
        ...
        final ResourceIterator<not_DriverCategory> iterator2 = new NestedIterator<not_DriverCategory, not_DriverCategory>(iterator1) {
                public ResourceIterator<not_DriverCategory> getNextIterator(
                    ...
                    return KBFragement_not_driverCategory_11.not_driverCategory_11(bindings.p1,
