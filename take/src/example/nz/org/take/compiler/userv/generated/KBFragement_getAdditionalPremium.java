...
class KBFragement_getAdditionalPremium {
    ...
    static ResourceIterator<AdditionalPremium> getAdditionalPremium(
        ...
        ResourceIterator<AdditionalPremium> result = new IteratorChain<AdditionalPremium>(8) {
                public Object getIteratorOrObject(int pos) {
                    ...
                    // AP_07  IF less_than(getAge(<car>),5) AND /isNew(<car>) THEN /additionalPremium(<policy>,<car>,300)
                    case 1:
                        return getAdditionalPremium_1(policy, car,
                            _derivation.reset(_derivationlevel));

                    // AP_08  IF greater_than_or_equal(getAge(<car>),5) AND less_than_or_equal(getAge(<car>),10) THEN /additionalPremium(<policy>,<car>,250)
                    case 2:
                        return getAdditionalPremium_2(policy, car,
                            _derivation.reset(_derivationlevel));

                    // AP_09  IF includesUninsuredMotoristCoverage(<policy>) THEN /additionalPremium(<policy>,<car>,300)
                    case 3:
                        return getAdditionalPremium_3(policy, car,
                            _derivation.reset(_derivationlevel));

                    // AP_10  IF includesMedicalCoverage(<policy>) THEN /additionalPremium(<policy>,<car>,600)
                    case 4:
    ...
    */
    private static ResourceIterator<AdditionalPremium> getAdditionalPremium_1(
        ...
        // Variable bindings in rule:  IF less_than(getAge(<car>),5) AND /isNew(<car>) THEN /additionalPremium(<policy>,<car>,300)
        class bindingsInRule43 {
            ...
            // Property generated for term  "<policy>"
            example.nz.org.take.compiler.userv.domainmodel.Policy p5;
        }
        ;
        ...
        bindings.p1 = 5;
        bindings.p2 = car;
        bindings.p3 = car.getAge();
        bindings.p5 = policy;
        bindings.p4 = 300;

        // code for prereq less_than(getAge(<car>),5)
        final ResourceIterator<less_than> iterator1 = KBFragement_less_than_11.less_than_11(bindings.p3,
                5, _derivation.increaseDepth());

        // code for prereq /isNew(<car>)
        final ResourceIterator<not_isNew> iterator2 = new NestedIterator<less_than, not_isNew>(iterator1) {
        ...
        final ResourceIterator<AdditionalPremium> iterator3 = new NestedIterator<not_isNew, AdditionalPremium>(iterator2) {
                public ResourceIterator<AdditionalPremium> getNextIterator(
                    ...
                    return new SingletonIterator(new AdditionalPremium(
                            bindings.p5, bindings.p2, bindings.p4));
                }
            };
    ...
    */
    private static ResourceIterator<AdditionalPremium> getAdditionalPremium_2(
        ...
        // Variable bindings in rule:  IF greater_than_or_equal(getAge(<car>),5) AND less_than_or_equal(getAge(<car>),10) THEN /additionalPremium(<policy>,<car>,250)
        ...
        bindings.p2 = car;
        bindings.p3 = 250;
        bindings.p5 = car.getAge();
        bindings.p4 = 10;
        bindings.p6 = policy;

        // code for prereq greater_than_or_equal(getAge(<car>),5)
        final ResourceIterator<greater_than_or_equal> iterator1 = KBFragement_greater_than_or_equal_11.greater_than_or_equal_11(bindings.p5,
                5, _derivation.increaseDepth());

        // code for prereq less_than_or_equal(getAge(<car>),10)
        final ResourceIterator<less_than_or_equal> iterator2 = new NestedIterator<greater_than_or_equal, less_than_or_equal>(iterator1) {
                public ResourceIterator<less_than_or_equal> getNextIterator(
                    ...
                    return KBFragement_less_than_or_equal_11.less_than_or_equal_11(bindings.p5,
                        bindings.p4, _derivation.increaseDepth());
                }
            };

        // code for prereq /additionalPremium(<policy>,<car>,250)
        final ResourceIterator<AdditionalPremium> iterator3 = new NestedIterator<less_than_or_equal, AdditionalPremium>(iterator2) {
                public ResourceIterator<AdditionalPremium> getNextIterator(
                    ...
                    return new SingletonIterator(new AdditionalPremium(
                            bindings.p6, bindings.p2, bindings.p3));
                }
            };
    ...
    private static ResourceIterator<AdditionalPremium> getAdditionalPremium_5(
        ...
        final ResourceIterator<AdditionalPremium> iterator2 = new NestedIterator<PotentialOccupantInjuryRating, AdditionalPremium>(iterator1) {
                public ResourceIterator<AdditionalPremium> getNextIterator(
                    ...
                    return new SingletonIterator(new AdditionalPremium(
                            bindings.p4, bindings.p3, bindings.p1));
                }
            };
    ...
    */
    private static ResourceIterator<AdditionalPremium> getAdditionalPremium_7(
        ...
        final bindingsInRule49 bindings = new bindingsInRule49();
        bindings.p1 = "high";
        bindings.p2 = car;
        bindings.p4 = policy;
        bindings.p3 = 500;
