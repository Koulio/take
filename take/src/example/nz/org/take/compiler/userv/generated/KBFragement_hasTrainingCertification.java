...
class KBFragement_hasTrainingCertification {
    ...
    */
    private static ResourceIterator<TrainedDriver> hasTrainingCertification_0(
        ...
        final ResourceIterator<_hasDriversTrainingFromSchool> iterator1 = KBFragement_hasDriversTrainingFromSchool_1.hasDriversTrainingFromSchool_1(driver,
                _derivation.increaseDepth());

        // code for prereq /hasTrainingCertification(<driver>)
        final ResourceIterator<TrainedDriver> iterator2 = new NestedIterator<_hasDriversTrainingFromSchool, TrainedDriver>(iterator1) {
    ...
    */
    private static ResourceIterator<TrainedDriver> hasTrainingCertification_1(
        ...
        // code for prereq /hasTrainingCertification(<driver>)
        final ResourceIterator<TrainedDriver> iterator2 = new NestedIterator<_hasDriversTrainingFromLicensedDriverTrainingCompany, TrainedDriver>(iterator1) {
                public ResourceIterator<TrainedDriver> getNextIterator(
    ...
    */
    private static ResourceIterator<TrainedDriver> hasTrainingCertification_2(
        ...
        // code for prereq /hasTrainingCertification(<driver>)
        final ResourceIterator<TrainedDriver> iterator2 = new NestedIterator<_hasTakenASeniorCitizenDriversRefresherCourse, TrainedDriver>(iterator1) {
                public ResourceIterator<TrainedDriver> getNextIterator(
