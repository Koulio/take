...
import test01.org.mandarax.compiler.prototype.generated.*;

/**
 * Tests2 for this scenario. 
...
public class Tests2 extends TestCase
{
	...
	public void test2(){
		_KB kb = new _KB();
		Iterator<_is_grandfather_of> results = kb.is_grandfather_of_10("Max");	
		assertTrue(results.hasNext());
