...
public class GenerateInterfaces {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			ScriptKnowledgeSource KSrc = new ScriptKnowledgeSource(Tests.class.getResourceAsStream("/test/nz/org/take/compiler/scenario8/rules8.take"));
			kb = KSrc.getKnowledgeBase();
		} catch (ScriptException e) {
			e.printStackTrace();
		}
		compiler.setPackageName("test.nz.org.take.compiler.scenario8.generated");
